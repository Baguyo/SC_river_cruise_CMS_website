                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-header">
                            <?php 
                                if($section == "about" && $source == "history"){
                                    include_once "includes/about_page/about_edit_history.php";
                                }elseif ($section == "about" && $source == "founder") {
                                    include_once "includes/about_page/about_edit_founder.php";
                                }elseif ($section == "staff" && $source == "add_staff") {
                                  include_once "includes/about_page/about_add_staff.php";
                                }elseif ($section == "staff" && $source == "view_staff") {
                                  include_once "includes/about_page/about_view_staff.php";
                                }elseif ($section == "staff" && $source == "edit_staff" && isset($_GET['id'])) {
                                  include_once "includes/about_page/about_edit_staff.php";
                                }
                            ?>
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        if(isset($_POST['delete_data'])){
            ...
            if($tbl == "guide"){
              ...
              $query = "DELETE FROM about_page_staff WHERE id = ?";
            }
