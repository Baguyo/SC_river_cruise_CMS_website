                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-header">
                            <?php 
                                if($source == "add"){
                                    include_once "includes/gallery_page/gallery_add_image.php";
                                }elseif ($source == "view") {
                                    include_once "includes/gallery_page/gallery_view_image.php";
                                }
                            ?>
...
<?php 
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        if(isset($_POST['delete_data'])){
            ...
            if($tbl == "gallery"){
               $query = "DELETE FROM gallery_page WHERE id = ?";
            }
